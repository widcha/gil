...
export function excludeFile(root) {
 ...
 */
export function ignoreUntracked(root, relPath) {
...
export function unignoreUntracked(root, relPath) {
...
export function listUntrackedIgnored(root) {
    return listEntries(excludeFile(root)).filter((e) => e !== IGNORE_REL);
}
//# sourceMappingURL=localIgnore.js.map